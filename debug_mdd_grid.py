...
os.chdir(r'e:\Antigravity\Grade Smart\\backend\\ref')
...
cv2.imwrite('backend/ref/debug_crop.png', crop)
cv2.imwrite('backend/ref/debug_thresh.png', thresh)
...
cv2.imwrite('backend/ref/debug_grid.png', vis)
print('saved debug_crop.png debug_thresh.png debug_grid.png')
